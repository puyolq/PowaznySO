...
#pragma region obsluga plikow
	...
	void zapiszDoPliku(std::string nazwa, std::string rozszerzenie,std::string dane, std::string nazwaFolderu ="Dysk"); //Pozwala na dopisywanie danych na koñcu pliku.
	std::string pobierzDane(std::string nazwa, std::string rozszerzenie, std::string nazwaFolderu = "Dysk"); // Zwraca dane z pliku.
	void otowrzStratnie(std::string nazwa, std::string rozszerzenie, std::string nazwaFolderu = "Dysk"); // Czyœwi plik, zwalnia bloki poza pierwszym blokiem.
